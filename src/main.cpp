...
// configuration step. It creates a namespace called `ftxui_template`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        ftxui_template::cmake::project_name,
        ftxui_template::cmake::project_version));// version string, acquired
